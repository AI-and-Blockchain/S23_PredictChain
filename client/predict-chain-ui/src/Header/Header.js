    ...
    <div className="fixed-header" id="#">
      <div className="container">
        <nav>
          ...
          <a href="/login" style={{ fontSize: "x-large", marginLeft: "150px" }}>
            Login
          </a>
          <a href="/faq" style={{ fontSize: "x-large", marginLeft: "150px" }}>
            FAQ
          </a>
          <a href="/mtt" style={{ fontSize: "x-large", marginLeft: "150px" }}>
            Meet The Team
          </a>
          <a
